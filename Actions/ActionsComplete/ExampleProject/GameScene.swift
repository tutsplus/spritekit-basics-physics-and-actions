...
class GameScene: SKScene {
    ...
    let example9Label = SKLabelNode(text: "Example9")
    let example10Label = SKLabelNode(text: "Example10")
    let example11Label = SKLabelNode(text: "Example11")

    override func didMove(to view: SKView) {
        let Labels = [example1Label,example2Label,example3Label,example4Label,example5Label,example6Label,
                      example7Label,example8Label,example9Label,example10Label,example11Label]
    ...
    override func touchesBegan(_ touches: Set<UITouch>, with event: UIEvent?) {
       let Scenes = [Example1(size: size),Example2(size: size),Example3(size: size),Example4(size: size),Example5(size: size),Example6(size: size),Example7(size: size),Example8(size: size),
                     Example9(size: size),Example10(size: size),Example11(size: size)]
